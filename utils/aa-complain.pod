...
B<aa-complain I<E<lt>executableE<gt>> [I<E<lt>executableE<gt>> ...] [I<-d /path/to/profiles>] [I<--no-reload>] [I<--force>]>
...
B<--force>
   Force the profile to be set to complain mode even if it is currently in unconfined mode.
