...
B<aa-enforce I<E<lt>executableE<gt>> [I<E<lt>executableE<gt>> ...] [I<-d /path/to/profiles>] [I<--no-reload>] [I<--force>]>
...
B<--force>
   Force the profile to be set to enforce mode even if it is currently in unconfined mode.
