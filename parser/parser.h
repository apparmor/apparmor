...
extern bool features_supports_unixv7;
extern bool features_supports_unixv9;
...
extern bool generic_add_prefix(struct cod_entry *entry, const prefixes &p, const char *&error);
